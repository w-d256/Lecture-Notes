...
\begin{notetheorem}[4.8 (Lagrange's root bound)]
Let $p$ be prime and
\[
...
\begin{notelemma}[(A lifting valuation)]
...
\begin{notetheorem}[4.17 (classification of primitive-root moduli)]
...
\begin{noteapplication}[4.1 (Caesar cipher)]
...
\begin{noteapplication}[4.2 (Diffie--Hellman key exchange)]
