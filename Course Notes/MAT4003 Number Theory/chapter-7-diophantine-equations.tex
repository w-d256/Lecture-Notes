...
\begin{noteremark}[(rational points on the circle)]
...
\begin{notetheorem}[7.7 (Fermat for exponent four)]
The equation
\[
 x^4+y^4=z^4
\]
...
\begin{notetheorem}[7.8 (local obstruction principle)]
