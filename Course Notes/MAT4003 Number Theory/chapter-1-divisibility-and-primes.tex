...
\begin{notetheorem}[1.2 (division algorithm, positive divisor)]
...
\begin{notetheorem}[1.3 (division algorithm)]
...
\begin{notetheorem}[1.4 (B\'ezout's lemma)]
...
\begin{notetheorem}[1.9 (Euclid's lemma)]
...
\begin{notetheorem}[1.12 (Euclidean algorithm)]
...
\begin{noteapplication}[1.1 (extended Euclidean algorithm)]
...
\begin{notetheorem}[1.16 (fundamental theorem of arithmetic)]
...
\begin{notetheorem}[1.17 (monic rational-root criterion)]
Let
\[
