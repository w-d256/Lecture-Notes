...
\begin{notetheorem}[0.1 (principle of mathematical induction)]
...
\begin{notetheorem}[0.2 (strong induction)]
...
\begin{notetheorem}[0.3 (well-ordering principle)]
Every nonempty subset of $\Nzero$ has a least element.
\end{notetheorem}

\begin{notetheorem}[0.4 (pigeonhole principle)]
